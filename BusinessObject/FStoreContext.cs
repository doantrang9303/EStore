    ...
    public partial class FStoreContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=localhost; Initial Catalog=eStore1; User Id=sa; Password=trang; Integrated Security=False ;TrustServerCertificate=true");
            }
        }
